...
const balance_proxy_1 = require('./balance-proxy');
const serial_port_publisher_1 = require('./serial-port-publisher');
...
//
////////////////////////////////////////////////////////////////////////////////
const serialPortSingleton = new serial_port_publisher_1.SerialPortPublisher();
////////////////////////////////////////////////////////////////////////////////
//
...
server.on("connection", (connection) => {
    const balanceServer = new balance_proxy_1.BalanceProxy(connection, serialPortSingleton);
